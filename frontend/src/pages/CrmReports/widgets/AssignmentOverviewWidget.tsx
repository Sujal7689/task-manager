...
export default function AssignmentOverviewWidget() {
  ...
  useEffect(() => {
    api
      .get("/crm-lead-reports/dashboard/assignment-overview", { params: { page, pageSize: PAGE_SIZE, search: search || undefined, createdSince, createdBefore, staffName } })
      .then((res) => {
        setRows(res.data.rows);
        setTotal(res.data.total);
      });
  }, [page, search, createdSince, createdBefore, staffName]);
