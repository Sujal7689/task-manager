...
import crmLeadsRoutes from "./modules/crmLeads/crmLeads.routes";
import crmLeadReportsRoutes from "./modules/crmLeads/crmLeadReports.routes";
...
app.use("/api/admin/crm-leads", crmLeadsRoutes);
app.use("/api/crm-lead-reports", crmLeadReportsRoutes);
